namespace YidanEHRReport
{
    ...
    /// <summary>
    /// Summary description for ReportPathEnForceLongOrder.
    /// </summary>
    public partial class ReportPathEnForceLongOrder : Telerik.Reporting.Report
    {
        public ReportPathEnForceLongOrder()
        {
            InitializeComponent();

            this.DataSource = null;
            this.NeedDataSource += new EventHandler(ReportPathEnForceLongOrder_NeedDataSource);
        }

        private void ReportPathEnForceLongOrder_NeedDataSource(object sender, EventArgs e)
        {
            ...
            this.tablePathEnForceLongOrder.DataSource = dt;
