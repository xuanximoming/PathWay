namespace YidanEHRReport
{
    ...
    /// <summary>
    /// Summary description for RgvQuestion.
    /// </summary>
    public partial class PathExitList : Telerik.Reporting.Report
    {
        //add by luff 20121018
        public PathExitList()
        {
            //
            ...
            InitializeComponent();
            //加载报表数据源
            this.NeedDataSource += new EventHandler(PathExitList_NeedDataSource);
          
            
        }

        void PathExitList_NeedDataSource(object sender, EventArgs e)
        {
            ...
            DataTable dt = sqlhelp.GetTableByPorc("usp_CP_PathExit", sqlparams);
