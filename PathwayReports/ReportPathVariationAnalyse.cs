namespace YidanEHRReport
{
    ...
    /// <summary>
    /// Summary description for ReportPathVariationAnalyse.
    /// </summary>
    public partial class ReportPathVariationAnalyse : Telerik.Reporting.Report
    {
        public ReportPathVariationAnalyse()
        {
            InitializeComponent();

            this.DataSource = null;
            this.NeedDataSource += new EventHandler(ReportPathVariationAnalyse_NeedDataSource);

        }

        private void ReportPathVariationAnalyse_NeedDataSource(object sender, EventArgs e)
        {
            ...
            DataTable dt = sqlhelp.GetTableByPorc("usp_CP_RptPathVariationAnalyse", sqlparams);

            this.tablePathVariationAnalyse.DataSource = dt;
