namespace YidanEHRReport
{
    ...
    /// </summary>
    public partial class ReportPathQuit : Telerik.Reporting.Report
    {
        public ReportPathQuit()
        {
        ...
        private void ReportPathQuit_NeedDataSource(object sender, EventArgs e)
        {
            ...
            DataTable dt = sqlhelp.GetTableByPorc("usp_CP_RptPathQuit", sqlparams);

            this.tableInpatientQuit.DataSource = dt;
